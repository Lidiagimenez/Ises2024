...
function MateriasTable() {
  ...
  const handleRowSelection = (row) => {
    // Aquí puedes actualizar el estado con la materia seleccionada
    setSelectedMateria(row);
    setSelectMateriaDelete(row); // También puedes actualizar el estado para borrar
